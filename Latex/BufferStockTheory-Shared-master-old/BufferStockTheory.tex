\input{./econtexRoot}\input{\econtexRoot/econtexPaths}\documentclass[titlepage]{\econtex}\providecommand{\texname}{FBS-NK}
...
\begin{figure}{}
    \centering\includegraphics[scale=.35]{\FigDir/CJACW_Comparison}
